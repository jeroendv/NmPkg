...
class Test_Integrate:
    ...
    testFilesPre = (Path(__file__).parent / Path("TestFiles/VsProjectIntegration.pre")).absolute()
    testFilesVerified =  (Path(__file__).parent / Path("TestFiles/VsProjectIntegration.verified")).absolute()
